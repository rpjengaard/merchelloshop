...
namespace code.Json.Models
{
   public class SkybrudDetachedPublishedProperty : IPublishedProperty
    {
        ...
        public SkybrudDetachedPublishedProperty(PublishedPropertyType propertyType, object value)
            : this(propertyType, value, false)
        {
        }

        public SkybrudDetachedPublishedProperty(PublishedPropertyType propertyType, object value, bool isPreview)
        {
