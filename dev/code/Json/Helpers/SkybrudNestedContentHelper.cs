...
namespace code.Json.Helpers
{
   
    public static class SkybrudNestedContentHelper
    {
        ...
        {
            var contentTypeAliasProperty = item[ContentTypeAliasPropertyKey];
        ...
        public static void ConvertItemValueFromV011(JObject item, int dtdId, ref PreValueCollection preValues)
        {
            ...
            if (preValueContentTypes.Any())
            {
                ...
                item[ContentTypeAliasPropertyKey] = preValueContentTypes.First().Value<string>("ncAlias");
            }
        }
